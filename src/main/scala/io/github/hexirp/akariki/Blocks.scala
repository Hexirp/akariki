...
class Blocks {
  ...
  val cleaned_cobble_stone : Block = new Block(Material.ROCK)
    .setRegistryName(new ResourceLocation(Metadata.MOD_ID, "cleaned_cobble_stone"))
    .setUnlocalizedName("cleaned_cobble_stone")
